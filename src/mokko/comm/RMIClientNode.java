    ...
    public RMIClientNode(NodeDescriptor nodeDescriptor, InetAddress inetAddress, int port, byte[] initData) {
        ...
        transportThread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                rmiProxyFactory.setServiceUrl("rmi://" + inetAddress.getHostName() + ":" + Integer.toString(port) + "/mokko.comm.ITransportPipe");
                rmiProxyFactory.setServiceInterface(mokko.comm.ITransportPipe.class);
